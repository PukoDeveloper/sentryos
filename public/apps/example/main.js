    ...
    return UI.column([
      ...
      UI.card([
        UI.column([
          ...
          UI.input({
            ...
            onSubmit: function (v) {
              OS.notification.notify('Submitted', v, 'info');
            },
          }),
      ...
      UI.card([
        UI.column([
          ...
          UI.row([
            UI.button('Info', {
              onClick: function () { OS.notification.notify('Hello!', 'This is an info notification.', 'info'); },
              style: styles.notifButton(styles.colors.info),
            }),
            UI.button('Success', {
              onClick: function () { OS.notification.notify('Done', 'Operation completed successfully.', 'success'); },
              style: styles.notifButton(styles.colors.success),
            }),
            UI.button('Warning', {
              onClick: function () { OS.notification.notify('Caution', 'Something needs your attention.', 'warning'); },
              style: styles.notifButton(styles.colors.warning),
            }),
            UI.button('Error', {
              onClick: function () { OS.notification.notify('Error', 'Something went wrong!', 'error'); },
      ...
      // Footer
      OS.ui.panel([
        OS.ui.label('PID: ' + OS.pid + '  |  Type: ' + OS.type, {
          fontSize: '11px',
